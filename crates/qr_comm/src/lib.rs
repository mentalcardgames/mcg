...
pub const CODING_FACTORS_PER_FRAME: usize = CODING_FACTORS_PER_PARTICIPANT_PER_FRAME * MAX_PARTICIPANTS;
pub const CODING_FACTORS_PER_PARTICIPANT_PER_FRAME: usize = 16;
pub const CODING_FACTORS_SIZE_BYTES: usize = (CODING_FACTORS_PER_PARTICIPANT_PER_FRAME * GALOIS_FIELD_POWER * MAX_PARTICIPANTS).div_ceil(8);
pub const CODING_FACTOR_OFFSET_SIZE_BITS: usize = 16;
pub const CODING_FACTOR_OFFSET_SIZE_BYTES: usize = (CODING_FACTOR_OFFSET_SIZE_BITS * MAX_PARTICIPANTS).div_ceil(8);
pub const CODING_FACTOR_WIDTH_SIZE_BYTES: usize = 16;
pub const NETWORK_CODING_SIZE_BYTES: usize = CODING_FACTOR_WIDTH_SIZE_BYTES + CODING_FACTOR_OFFSET_SIZE_BYTES + CODING_FACTORS_SIZE_BYTES;
pub const FRAGMENT_SIZE_BYTES: usize = 679;
pub const FRAGMENTS_PER_PARTICIPANT_PER_EPOCH: usize = 2usize.pow(CODING_FACTOR_OFFSET_SIZE_BITS as u32) + CODING_FACTORS_PER_PARTICIPANT_PER_FRAME - 1;
pub const FRAGMENTS_PER_EPOCH: usize = FRAGMENTS_PER_PARTICIPANT_PER_EPOCH * MAX_PARTICIPANTS;
pub const FRAME_SIZE_BYTES: usize = HEADER_SIZE_BYTES + NETWORK_CODING_SIZE_BYTES + FRAGMENT_SIZE_BYTES;
...
mod tests {
    ...
    fn test_spec_v4() {
        ...
        assert_eq!(CODING_FACTORS_PER_FRAME, 256);
        assert_eq!(CODING_FACTORS_PER_PARTICIPANT_PER_FRAME, 16);
        assert_eq!(CODING_FACTORS_SIZE_BYTES, 128);
        ...
        assert_eq!(NETWORK_CODING_SIZE_BYTES, 176);
        assert_eq!(FRAGMENT_SIZE_BYTES, 679);
        assert_eq!(FRAGMENTS_PER_PARTICIPANT_PER_EPOCH, 65551);
        assert_eq!(FRAGMENTS_PER_EPOCH, 1048816);
        // assert_eq!(FRAME_SIZE_BYTES, 1367);
        assert_eq!(GALOIS_FIELD_POWER, 4);
        assert_eq!(GALOIS_FIELD, 16);
        assert_eq!(EPOCH_SIZE_BYTES, 712146064);
        assert_eq!(BYTES_PER_PARTICIPANT, 44509129);
        assert_eq!(QR_CODE_VERSION, Version::Normal(20));
        assert_eq!(QR_CODE_ECC, EcLevel::L);
        assert_eq!(AP_LENGTH_INDEX_SIZE_BITS, 18);
        assert_eq!(AP_LENGTH_INDEX_SIZE_BYTES, 3);
        assert_eq!(AP_MAX_SIZE_BYTES, 173821);
    }
}
