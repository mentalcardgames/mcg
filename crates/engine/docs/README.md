...
├── test_games/                    — 65 .cgdsl fixture files (incl. the five demo games) + .txt replay pairs
...
```
cargo test -p cgdsl-engine              # 553 tests (463 lib + 5 cgdsl-play + 9 TUI + 76 integration)
