...
use eframe::Frame;
use egui::{Context, vec2, ScrollArea, Color32, RichText};
    ...
    fn update(&mut self, next_screen: Rc<RefCell<ScreenType>>, ctx: &Context, _frame: &mut Frame) {
        egui::CentralPanel::default().show(ctx, |ui| {
            ui.vertical_centered(|ui| {
                ...
                // Back button
                if ui.add_sized(vec2(100.0, 30.0), egui::Button::new("← Back")).clicked() {
                ...
                match &current_state {
                    ...
                    LoadingState::Loaded(posts) => {
                        if ui.add_sized(vec2(150.0, 30.0), egui::Button::new("Refresh")).clicked() {
